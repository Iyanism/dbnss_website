...
export default function EventsMainBanner() {
    return (
        <section className="relative h-[60vh] md:h-[70vh] flex items-center justify-center overflow-hidden">
            <Image
                src="/dbnss/teachers_day_2024/WhatsApp Image 2026-03-02 at 9.45.43 PM.webp"
                alt="DBNSS Events"
                fill
                priority
                ...
                <div className="max-w-4xl">
                    ...
                    >
                        ...
                        <p className="text-lg md:text-2xl text-white/90 font-medium max-w-2xl leading-relaxed drop-shadow-md">
                            A celebration of talent, intellect, and community spirit through every season at DBNSS.
                        </p>
                    </motion.div>
                </div>
            </div>
